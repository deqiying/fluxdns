...
| Runtime | `backend/src/runtime/*` | [runtime.md](backend-modules/runtime.md) | 已完成 | 实现中 | 45% | 12% |
...
| Resource | `backend/src/resource/*` | [resource.md](backend-modules/resource.md) | 已完成 | 实现中 | 75% | 7% |
...
```text
4% × 45% + 8% × 35% + 10% × 100% + 12% × 45% + 11% × 50% + 10% × 55% + 8% × 65% + 10% × 99% + 9% × 50% + 7% × 75% + 8% × 35% + 3% × 30% ≈ 58.2%
```
