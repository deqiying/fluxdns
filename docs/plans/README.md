...
| [WebUI 重构开发总计划](webui-management-development-plan.md) | 有效 | 实施中 | P0 内部契约已交付；P1 可独立子项已推进；P2 的 BC-06 至 BC-13、固定契约/只读前端基础及提前授权的 BC-26 已完成；P3-P5 其余范围未授权 |
...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | BC-06 至 BC-13 与提前授权的 BC-26 已完成；P3 写入、BC-24/25 实时通道与 BC-27 未授权 |
