...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | P1 配置事务及 BC-06 至 BC-13、BC-26 已完成；P3 代理、Hosts、规则集已接线，其余模块实施中 |
| [WebUI 前端开发计划](webui-management-frontend-development-plan.md) | 有效 | 实施中 | FC-01/02、FC-14 与 FC-16 全局基础已交付；FC-09/10/12 完成，其余 P3 页面及组合采用实施中 |
