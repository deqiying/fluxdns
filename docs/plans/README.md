...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | BC-02 内部能力、BC-03 差量 socket/任务预注册/请求 drain/服务队列消费者已落实；完整应用/持久化未完成；BE-01 启动及 BC-26 待新 owner |
