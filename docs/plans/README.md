...
| [WebUI 重构开发总计划](webui-management-development-plan.md) | 有效 | 实施中 | P0 内部契约已交付；P1 已授权，后端内部底座、客户端 name/ID 索引、BC-23 指标与 12 路由壳层已推进，P2-P5 未授权 |
...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | BC-02/03/29/30/31 内部能力及 BC-04 name/ID 索引已推进，BC-23 已完成；BC-05 与完整生产接线未完成；BE-01 启动及 BC-26 待新 owner |
