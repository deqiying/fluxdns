...
| 计划 | 文档状态 | 计划状态 | 剩余范围 |
| --- | --- | --- | --- |
| [后端契约验证开发计划](backend-contract-validation.md) | 草案 | 待评审 | 已验收 D1-D9 独立收口；按本地确定性、隔离环境、持续恢复与长期负载顺序，评审 V0-V10 工作包、依赖及验收门槛 |
| [WebUI 管理后台重构需求](webui-management-requirements.md) | 草案 | 待评审 | 确认 12 个一级模块、配置编辑、实时推送需求与 6 张视觉草案（含服务状态深色模式、解析记录列表及悬浮详情）；后续开展详细设计和前后端实施 |
