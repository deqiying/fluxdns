...
| 计划 | 文档状态 | 计划状态 | 剩余范围 |
| --- | --- | --- | --- |
| [后端契约差距核对](backend-contract-gaps.md) | 草案 | 待评审 | 已确认保留配置语义与异步主链；评审 D1-D9 的具体取舍与运行验收范围 |
| [WebUI 管理后台重构需求](webui-management-requirements.md) | 草案 | 待评审 | 确认 12 个一级模块、配置编辑与实时推送需求；后续开展页面设计和前后端实施 |
