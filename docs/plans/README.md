...
| [WebUI 重构开发总计划](webui-management-development-plan.md) | 有效 | 实施中 | P0 内部契约已交付；P1 可独立子项已推进；P2 已授权，BC-06/07 快照与 BC-08 分片写入已完成，继续跨分片读口/保留/查询；P3-P5 未授权 |
...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | BC-02/03/29/30/31 内部能力、BC-04/05 身份链与 BC-23 指标已推进；BC-06/07 快照、BC-08 分片生产 writer 已完成，P2 读口/保留/查询继续，BC-26 留 P5 |
