...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | P1 配置事务及 BC-06 至 BC-13、BC-26 已完成；P3 基础资源、上游/组与策略已接线，其余模块实施中 |
| [WebUI 前端开发计划](webui-management-frontend-development-plan.md) | 有效 | 实施中 | FC-01/02、FC-06、FC-08 至 FC-10、FC-12/14 与 FC-16 全局基础已交付；其余 P3 页面及组合采用实施中 |
