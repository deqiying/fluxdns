...
| [WebUI 重构开发总计划](webui-management-development-plan.md) | 有效 | 实施中 | P0 内部契约已交付；P1 可独立子项已推进；P2 的 BC-06 至 BC-12 及提前授权的 BC-26 已完成，继续 BC-13 历史查询；P3-P5 其余范围未授权 |
...
| [WebUI 后端开发计划](webui-management-backend-development-plan.md) | 有效 | 实施中 | BC-06 至 BC-12 与提前授权的 BC-26 已完成；P2 仅余 BC-13 正式历史查询，P3 写入与 BC-27 未授权 |
