...
本目录保存后端模块级文档。跨模块架构由[后端架构设计](../architecture.md)维护，配置公共契约由[配置字段参考](../configuration-reference.md)维护。
...
- 模块行为变化时，在同一变更中更新对应文档；影响跨模块契约或配置契约时，再同步更新相应权威文档。
- 具体格式、状态和废弃流程遵循[文档维护规范](../../rules/documentation-maintenance.md)。
